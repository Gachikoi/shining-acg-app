...
import (
	...
	"app.shiningacg.club/service/user/internal/interceptor"
	"app.shiningacg.club/service/user/internal/service"
...
func main() {
	...
	authPath, authHandler := userconnect.NewAuthServiceHandler(&service.AuthServiceServer{})
	...
	fmt.Printf("Service registered at prefix: %s\n", authPath)
	// 这会输出类似 "/api.v1.user.AuthService/"
