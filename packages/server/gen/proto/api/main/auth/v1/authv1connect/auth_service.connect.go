...
import (
	v1 "app.shiningacg.club/gen/proto/api/main/auth/v1"
...
const (
	...
	AuthServiceName = "api.main.auth.v1.AuthService"
)
...
const (
	...
	AuthServiceLoginProcedure = "/api.main.auth.v1.AuthService/Login"
	// AuthServiceLogoutProcedure is the fully-qualified name of the AuthService's Logout RPC.
	AuthServiceLogoutProcedure = "/api.main.auth.v1.AuthService/Logout"
	// AuthServiceRefreshTokenProcedure is the fully-qualified name of the AuthService's RefreshToken
	// RPC.
	AuthServiceRefreshTokenProcedure = "/api.main.auth.v1.AuthService/RefreshToken"
	// AuthServiceUpdatePushTokenProcedure is the fully-qualified name of the AuthService's
	// UpdatePushToken RPC.
	AuthServiceUpdatePushTokenProcedure = "/api.main.auth.v1.AuthService/UpdatePushToken"
)

// AuthServiceClient is a client for the api.main.auth.v1.AuthService service.
...
// NewAuthServiceClient constructs a client for the api.main.auth.v1.AuthService service. By
...
// Login calls api.main.auth.v1.AuthService.Login.
func (c *authServiceClient) Login(ctx context.Context, req *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return c.login.CallUnary(ctx, req)
}

// Logout calls api.main.auth.v1.AuthService.Logout.
...
// RefreshToken calls api.main.auth.v1.AuthService.RefreshToken.
...
// UpdatePushToken calls api.main.auth.v1.AuthService.UpdatePushToken.
...
// AuthServiceHandler is an implementation of the api.main.auth.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/api.main.auth.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.main.auth.v1.AuthService.Login is not implemented"))
}

func (UnimplementedAuthServiceHandler) Logout(context.Context, *connect.Request[v1.LogoutRequest]) (*connect.Response[v1.LogoutResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.main.auth.v1.AuthService.Logout is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) RefreshToken(context.Context, *connect.Request[v1.RefreshTokenRequest]) (*connect.Response[v1.RefreshTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.main.auth.v1.AuthService.RefreshToken is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) UpdatePushToken(context.Context, *connect.Request[v1.UpdatePushTokenRequest]) (*connect.Response[v1.UpdatePushTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.main.auth.v1.AuthService.UpdatePushToken is not implemented"))
}
