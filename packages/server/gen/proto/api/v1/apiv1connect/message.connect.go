...
const (
	...
	MessageServiceListConversationsProcedure = "/api.v1.MessageService/ListConversations"
	...
	MessageServiceListNotificationsProcedure = "/api.v1.MessageService/ListNotifications"
	// MessageServiceMarkReadProcedure is the fully-qualified name of the MessageService's MarkRead RPC.
	MessageServiceMarkReadProcedure = "/api.v1.MessageService/MarkRead"
)
...
// ListConversations calls api.v1.MessageService.ListConversations.
...
// ListNotifications calls api.v1.MessageService.ListNotifications.
...
// MarkRead calls api.v1.MessageService.MarkRead.
...
func (UnimplementedMessageServiceHandler) ListConversations(context.Context, *connect.Request[v1.ListConversationsRequest]) (*connect.Response[v1.ListConversationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.MessageService.ListConversations is not implemented"))
}
...
func (UnimplementedMessageServiceHandler) ListNotifications(context.Context, *connect.Request[v1.ListNotificationsRequest]) (*connect.Response[v1.ListNotificationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.MessageService.ListNotifications is not implemented"))
}
...
func (UnimplementedMessageServiceHandler) MarkRead(context.Context, *connect.Request[v1.MarkReadRequest]) (*connect.Response[v1.MarkReadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.MessageService.MarkRead is not implemented"))
}
