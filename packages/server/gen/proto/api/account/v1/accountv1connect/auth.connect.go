...
const (
	...
	AuthServiceName = "api.account.v1.AuthService"
)
...
const (
	...
	AuthServiceLoginProcedure = "/api.account.v1.AuthService/Login"
	// AuthServiceLogoutProcedure is the fully-qualified name of the AuthService's Logout RPC.
	AuthServiceLogoutProcedure = "/api.account.v1.AuthService/Logout"
...
// Logout calls api.account.v1.AuthService.Logout.
...
// RefreshToken calls api.account.v1.AuthService.RefreshToken.
...
func (UnimplementedAuthServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.account.v1.AuthService.Login is not implemented"))
}

func (UnimplementedAuthServiceHandler) Logout(context.Context, *connect.Request[v1.LogoutRequest]) (*connect.Response[v1.LogoutResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.account.v1.AuthService.Logout is not implemented"))
}
